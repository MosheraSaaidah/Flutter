            ...
            child: ListView(
              ...
              children: [
                Row(
                  ...
                  children: [
                  Text('Omesha Shop',style: TextStyle(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: NetworkImage(avatar.isNotEmpty ? avatar:
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text('See All',style: TextStyle(color: Color(0xFFB2594B)),),
                  ],
                ),
                SizedBox(height: 15,),
                Categories(),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Popular Fashion',style: TextStyle(fontWeight: FontWeight.w600)),
                    Text('See All',style: TextStyle(color:Color(0xFFB2594B)),)
                  ],
                ),
                SizedBox(height: 15,),
